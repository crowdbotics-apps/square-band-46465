"""
Django settings for square_band_46465 project.
...
ROOT_URLCONF = 'square_band_46465.urls'
...
WSGI_APPLICATION = 'square_band_46465.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_band_46465 API",
    "DESCRIPTION": "API documentation for square_band_46465 App",
    "VERSION": "v1",
}
